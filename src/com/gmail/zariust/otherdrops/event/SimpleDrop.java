...
public class SimpleDrop extends CustomDrop {
    ...
    public String getDropName() {
        if (dropped == null) {
            return "NULL";
        } else if (dropped instanceof ItemDrop && ((ItemDrop) dropped).getMaterial() == null) {
            return "DEFAULT";
        } else if (dropped instanceof ItemDrop && ((ItemDrop) dropped).getMaterial() == Material.AIR
                && (getReplacementBlock() == null || getReplacementBlock().getMaterial() == null)) {
            return "DENY";
        }
    ...
    public void setDropSpread(ConfigurationNode node, String parameterName, boolean def) {
        ...
        if (spread instanceof Boolean) {
            ...
            this.dropSpread = OtherDropsConfig.parseChanceFrom(node, parameterName);
        } else {
