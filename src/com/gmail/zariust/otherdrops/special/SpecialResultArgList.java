...
public class SpecialResultArgList extends AbstractSequentialList<String> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("iter1: " + iter1.next() + ", iter2: " + iter2.next());
        iter1.remove();
        ...
        System.out.println(list.toString() + " " + list.size());
//		// Testing concurrent addition (commented out because it throws an exception, as it should)
//		System.out.println("---");
//		list = new DropEventArgList("PING","PONG","CLANG","PRANG","BOOM","BANG","SPLOOSH");
//		System.out.println(list.toString() + " " + list.size());
//		int i = 1;
//		for(String str : list) {
//			list.add(i, str + "ED");
