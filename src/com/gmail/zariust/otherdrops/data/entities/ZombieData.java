...
public class ZombieData extends CreatureData {
    ...
    Boolean villager = null; // Is this zombie a villager?  null = wildcard
    Boolean adult = null;    // Zombie's are not "Ageable" - baby/adult is handled differently
    ...
    public static CreatureData parseFromEntity(Entity entity) {
        if (entity instanceof Zombie) {
            return new ZombieData(((Zombie) entity).isVillager(), (!((Zombie) entity).isBaby()), (LivingEntityData) LivingEntityData.parseFromEntity(entity));
        } else {
