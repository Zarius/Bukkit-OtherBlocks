...
public class WolfData extends CreatureData {
    ...
    public WolfData(Boolean angry, Boolean tamed, DyeColor collarColor, AgeableData ageData) {
        this.angry = angry;
        this.tamed = tamed;
    ...
    public static CreatureData parseFromEntity(Entity entity) {
        if (entity instanceof Wolf) {
            return new WolfData(((Wolf) entity).isAngry(), ((Wolf) entity).isTamed(), ((Wolf) entity).getCollarColor(), (AgeableData) AgeableData.parseFromEntity(entity));
        } else {
