...
public class EndermanData extends CreatureData {
    ...
    public EndermanData(MaterialData type, Boolean canCarry, LivingEntityData leData) {
        this.md = type;
    ...
    public static CreatureData parseFromEntity(Entity entity) {
        if (entity instanceof Enderman) {
            return new EndermanData(((Enderman) entity).getCarriedMaterial(), ((Enderman) entity).getCanPickupItems(), (LivingEntityData) LivingEntityData.parseFromEntity(entity));
        } else {
