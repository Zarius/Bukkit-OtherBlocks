...
public class ExplosionAgent implements Agent {
    ...
    public ExplosionAgent(Entity boom) { // Actual explosion
        this(new CreatureSubject(boom.getType()), CommonEntity.getExplosiveType(boom));
        bomb = boom;
    }
    ...
    public static Agent parse(String name, String data) {
        if (name.equalsIgnoreCase("EXPLOSION") || name.equalsIgnoreCase("EXPLOSION_ANY")) {
    ...
    public String toString() {
        ...
        if (explosive instanceof CreatureSubject) {
            return "EXPLOSION_" + ((CreatureSubject) explosive).toString().replace("CREATURE_", "");
        }
